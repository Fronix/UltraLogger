...
public class PluginLogger implements Listener{
	...
	public PluginLogger(MainLogger main,boolean is,int max){
		this.plugin=main;
	...
	public void onEnable(PluginEnableEvent e){
		...
		out.println(time+pl.getName()+" "+plugin.translate("plugin.enable"));
	}
	@EventHandler
	public void onDisable(PluginDisableEvent e){
		...
		out.println(time+pl.getName()+" "+plugin.translate("plugin.disable"));
	}
	public void log(Plugin i,String event,EventPriority p){
		out.println(i.getName()+" "+plugin.translate("plugin.register.event")+" "+event+" "+plugin.translate("plugin.priority")+" "+p.name());
	}
	public void disable(){
		out.close();
	}
